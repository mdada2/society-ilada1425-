        ...
        <div className="p-6 max-w-2xl mx-auto">
            ...
            {activeTab === 'standard' ? (
                <div className="animate-fade-in">
                    ...
                    {result && (
                        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border dark:border-slate-700 animate-fade-in">
                ...
                <div className="animate-fade-in">
                    ...
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border dark:border-slate-700 mb-6 border-l-4 border-l-amber-500">
